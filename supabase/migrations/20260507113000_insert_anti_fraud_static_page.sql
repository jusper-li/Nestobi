/*
  # Insert anti-fraud static page

  Adds the Anti-Fraud statement page copied from the authorized DLAL source:
  https://www.dlalshop.com/pages/anti-fraud
*/

INSERT INTO public.static_pages (slug, title, meta_description, content, updated_at, updated_by)
VALUES (
  'anti-fraud',
  '防詐騙宣導',
  'Nestobi 防詐騙宣導，提醒常見詐騙手法與 165 反詐騙專線查證方式。',
