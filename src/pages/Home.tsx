...
export default function Home() {
  ...
  const t = {
    pageTitle: t4('nestopi・根本在旅行・咖啡旅行家', 'nestopi, Genbon Travel Shop, and Coffee Traveler', 'nestopi・根本在旅行・コーヒートラベラー', 'nestopi, 근본재여행, 커피 트래블러'),
    pageDesc: t4('住宿交給 nestopi，商品與門市交給根本在旅行，文章由咖啡旅行家獨立展開。', 'nestopi is for stays, Genbon Travel Shop is for products and stores, and Coffee Traveler is the independent article theme.', '宿泊はnestopi、商品と店舗は根本在旅行、記事はコーヒートラベラーとして独立展開します。', '숙박은 nestopi, 상품과 매장은 근본재여행, 글은 커피 트래블러가 독립적으로 다룹니다.'),
    heroTitle1: t4('三個主題', 'Three Themes', '3つのテーマ', '세 가지 주제'),
    heroTitle2: t4('各自清楚出發', 'Clearly Separated', 'それぞれ明確に', '명확하게 나누어'),
    heroDesc: t4('nestopi 專注住宿；根本在旅行負責商品與門市；咖啡旅行家獨立整理文章內容，三個主題清楚分工，也能在會員中心彼此連動。', 'nestopi focuses on stays, Genbon Travel handles products and stores, and Coffee Traveler organizes articles as its own theme.', 'nestopiは宿泊、根本在旅行は商品と店舗、コーヒートラベラーは記事を独立テーマとして整理します。', 'nestopi는 숙박, 근본재여행은 상품과 매장, 커피 트래블러는 글 콘텐츠를 독립 주제로 정리합니다.'),
    shopNow: t4('逛根本在旅行', 'Shop Genbon Travel', '根本在旅行を見る', '근본재여행 보기'),
    exploreStays: t4('前往 nestopi', 'Explore nestopi', 'nestopiへ', 'nestopi 보기'),
    stays: t4('nestopi', 'nestopi', 'nestopi', 'nestopi'),
    shop: t4('根本在旅行', 'Genbon Travel Shop', '根本在旅行', '근본재여행'),
    journal: t4('咖啡旅行家', 'Coffee Traveler', 'コーヒートラベラー', '커피 트래블러'),
    featuredStays: t4('nestopi 精選住宿', 'nestopi Featured Stays', 'nestopi 注目の宿泊', 'nestopi 추천 숙소'),
    ...
    viewAllStays: t4('查看 nestopi 住宿', 'View nestopi Stays', 'nestopiの宿泊を見る', 'nestopi 숙소 보기'),
    ...
    trustStaysTitle: t4('nestopi 住宿', 'nestopi Stays', 'nestopi 宿泊', 'nestopi 숙소'),
