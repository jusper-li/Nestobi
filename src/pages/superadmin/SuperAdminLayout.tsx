...
const SuperAdminLayout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/superadmin/rooms', icon: <BedDouble className="h-5 w-5" />, label: pick('nestopi 住宿', 'nestopi Stays', 'nestopi 宿泊', 'nestopi 숙소') },
    { to: '/superadmin/room-translations', icon: <Languages className="h-5 w-5" />, label: pick('nestopi 翻譯', 'nestopi Translations', 'nestopi 翻訳', 'nestopi 번역') },
