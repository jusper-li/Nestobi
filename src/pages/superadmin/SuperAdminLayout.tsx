...
const SuperAdminLayout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { to: '/superadmin/rooms', icon: <BedDouble className="h-5 w-5" />, label: pick('Nestopia 住宿', 'Nestopia Stays', 'Nestopia 宿泊', 'Nestopia 숙소') },
    { to: '/superadmin/room-translations', icon: <Languages className="h-5 w-5" />, label: pick('Nestopia 翻譯', 'Nestopia Translations', 'Nestopia 翻訳', 'Nestopia 번역') },
