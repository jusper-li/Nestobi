  ...
  home: [
    {
      ...
      title_ja: '3つのテーマ\nそれぞれ明確に',
      title_ko: '세 가지 주제\n명확하게 나누어',
      subtitle_zh: 'nestobi 專注住宿；根本在旅行負責商品與門市；咖啡旅行家獨立整理文章內容，三個主題清楚分工，也能在會員中心彼此連動。',
      subtitle_en: 'nestobi focuses on stays, Genbon Travel handles products and stores, and Coffee Traveler organizes articles as its own theme.',
      subtitle_ja: 'nestobiは宿泊、根本在旅行は商品と店舗、コーヒートラベラーは記事を独立テーマとして整理します。',
      subtitle_ko: 'nestobi는 숙박, 근본재여행은 상품과 매장, 커피 트래블러는 글 콘텐츠를 독립 주제로 정리합니다.',
