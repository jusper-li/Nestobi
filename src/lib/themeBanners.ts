  ...
  home: [
    {
      ...
      title_ja: '3つのテーマ\nそれぞれ明確に',
      title_ko: '세 가지 주제\n명확하게 나누어',
      subtitle_zh: 'nestopi 專注住宿；根本在旅行負責商品與門市；咖啡旅行家獨立整理文章內容，三個主題清楚分工，也能在會員中心彼此連動。',
      subtitle_en: 'nestopi focuses on stays, Genbon Travel handles products and stores, and Coffee Traveler organizes articles as its own theme.',
      subtitle_ja: 'nestopiは宿泊、根本在旅行は商品と店舗、コーヒートラベラーは記事を独立テーマとして整理します。',
      subtitle_ko: 'nestopi는 숙박, 근본재여행은 상품과 매장, 커피 트래블러는 글 콘텐츠를 독립 주제로 정리합니다.',
    ...
    },
    {
      ...
      link_url: '/rooms',
      link_label_zh: '前往 nestopi',
      link_label_en: 'Explore nestopi',
      link_label_ja: 'nestopiへ',
      link_label_ko: 'nestopi 보기',
      display_order: 20,
    },
  ],
  nestopia: [
    {
      ...
      title_ja: '次の景色に泊まる',
      title_ko: '다음 풍경에 머물다',
      subtitle_zh: '以民宿、房型與城市感受為核心，讓 nestopi 成為住宿的入口。',
      subtitle_en: 'nestopi starts from stays, rooms, cities, and the feeling of arriving.',
      subtitle_ja: '民宿、客室、街の空気から、nestopi は宿泊の入口になります。',
      subtitle_ko: '숙소, 객실, 도시의 감각에서 nestopi 숙박이 시작됩니다.',
